        ...
        $.ajax({
            ...
            success: function(data){
                ...
                var plotObj = $.plot($("#flot-line-chart"), [{
                        data: data.final_chart_line,
                        label: "mail's"
                    }],
                    options);
                
                
                var data_attach = data.graph_pie_attach;
                var data_file = data.graph_pie_file;
                
                
                var plotObj = $.plot($("#flot-pie-chart_left"), data_attach, {
                    series: {
                        pie: {
                            show: true
                        }
                ...
                var plotObj = $.plot($("#flot-pie-chart_right"), data_file, {
                    series: {
                        pie: {
                            show: true
                        }
...
//                 
//                 var plotObj = $.plot($("#flot-pie-chart_left"), data, {
//                     series: {
//                         pie: {
//                         show: true
//                     }
